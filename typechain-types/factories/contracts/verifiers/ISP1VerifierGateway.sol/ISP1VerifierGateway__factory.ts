...
} from "../../../../contracts/verifiers/ISP1VerifierGateway.sol/ISP1VerifierGateway";
...
export class ISP1VerifierGateway__factory {
  ...
  static createInterface(): ISP1VerifierGatewayInterface {
    return new Interface(_abi) as ISP1VerifierGatewayInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ISP1VerifierGateway;
  }
}
